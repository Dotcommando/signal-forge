...
import { IGetLatestContentItemsRequest, ILatestContentSourceRequest, IValidatedLatestContentItemsRequest } from '../types/get-latest-content-items-request.interface';
import { JOURNAL_API_PROVIDER_ARRAY } from '../types/journal-api-provider.enum';
import { LATEST_CONTENT_SOURCE_KIND, LATEST_CONTENT_SOURCE_KIND_ARRAY } from '../types/latest-content-source-kind.enum';
...
import { REDDIT_COMMUNITY_SORT_ARRAY } from '../types/reddit-community-sort.enum';
